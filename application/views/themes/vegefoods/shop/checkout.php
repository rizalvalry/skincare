<script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js"
    data-client-key="Mid-client-pRj7AeaWKUAYnaee"></script>
                            ...
                            <div class="cart-detail p-3 p-md-4">
                                ...
                                <div class="crappy">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="radio">
                                                <label><input type="radio" name="payment" class="mr-2" value="3"
                                                        checked> Payment Gateway</label>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="radio">
                                                <label><input type="radio" name="payment" id="manual" class="mr-2"
                                                        value="1"> Bayar ditempat</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
