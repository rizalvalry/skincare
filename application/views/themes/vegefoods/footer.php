...
function getLocation() {
    ...
    if (navigator.geolocation) {
        ...
        status.innerText = "Browser Anda tidak mendukung Geolocation.";
    }
}
...
function success(position) {
    ...
    document.getElementById('status').innerText = `Lokasi Anda: Lat ${latitude}, Lng ${longitude}`;

    fetch('<?= base_url("location/save") ?>', {
            method: 'POST',
            headers: {
...
function error(err) {
    document.getElementById('status').innerText = `Gagal mendapatkan lokasi: ${err.message}`;
}
