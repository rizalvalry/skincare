...
<section id="home-section" class="hero">
    <div class="home-slider owl-carousel">
        ...
        <div class="slider-item"
            style="background-image: url(<?php echo base_url('assets/uploads/banners/'.$slider->picture_name); ?>);">
            <div class="overlay"></div>
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

                    <div class="col-md-12 ftco-animate text-center">
                        <h1 class="mb-2"><?php echo $slider->title; ?></h1>
                        <h2 class="subheading mb-4"><?php echo $slider->subtitle; ?></h2>
                        <p><a href="#products" class="btn btn-primary"><?php echo $slider->button_text; ?></a></p>
                    </div>
...
<header class="nav-header">
    <nav class="middle scroll">
        <?php $i=1; foreach($brands as $brands): ?>
        <span class="item"><img src="<?php echo base_url('assets/uploads/brands/'.$brands->picture_name); ?>"
                style="width:100px; height:100px; border-radius:7px;"></span>
        <?php $i++; endforeach; ?>
    </nav>
</header>
            ...
            <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
                <div class="media block-6 services mb-md-0 mb-4">
                    ...
                    <div class="media-body">
                        ...
                        <span>Diolah Langsung dari Peternakan</span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
...
<div class="container">
    <div class="row justify-content-center mb-3 pb-3">
        <div class="col-md-12 heading-section text-center ftco-animate">
            <span class="subheading">Ada Harga Diskon nih Guys</span>
...
<!-- card discount -->
<menu>
    <?php $i=1; foreach($discount as $discount): ?>
    <scroll>
        <div class="container mt-4">
            <a href="<?php echo site_url('shop/product/'. $discount->id .'/'. $discount->sku .'/'); ?>"
                class="img-prod">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="<?php echo base_url('assets/uploads/products/'. $discount->picture_name); ?>"
                                class="card-img" alt="<?php echo $discount->name; ?>">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title"><?php
            $num_char = 20;
            echo substr($discount->name, 0, $num_char). ''; ?></h5>
                                <p class="card-text text-danger" style="text-decoration: line-through;">
                                    <?php echo format_rupiah($discount->price); ?> </p>
                                <h4 class="card-text font-weight-bold">
                                    <?php echo format_rupiah($discount->price - $discount->current_discount); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="product">
                    <a href="<?php echo site_url('shop/product/'. $product->id .'/'. $product->sku .'/'); ?>"
                        ...
                        <img class="img-fluid"
                            ...
                            alt="<?php echo substr($product->name, 0, -1); ?>">
                    ...
                    <div class="text py-3 pb-4 px-3 text-center">
                        <h3><a
                                href="<?php echo site_url('shop/product/'. $product->id .'/'. $product->sku .'/'); ?>"><?php echo substr($product->name, 12, -5); ?></a>
                        </h3>
                        <div class="d-flex">
                            <div class="pricing">
                                <p class="price">
...
<section class="ftco-section img" style="background-size: contain;
    background-position: left;
    background-repeat: no-repeat;background-image: url(<?php echo get_theme_uri('images/bg_3.jpg'); ?>);">
    <div class="container">
