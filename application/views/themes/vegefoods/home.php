...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo base_url('assets/uploads/banners/'.$slider->picture_name); ?>);">
  ...
  <header class="nav-header">
    ...
    <?php $i=1; foreach($brands as $brands): ?>
      <span class="item"><img src="<?php echo base_url('assets/uploads/brands/'.$brands->picture_name); ?>" style="width:100px; height:100px; border-radius:7px;"></span>
      <?php $i++; endforeach; ?>
    </nav>
  </header>
...
<scroll><div class="container mt-4">
<a href="<?php echo site_url('shop/product/'. $discount->id .'/'. $discount->sku .'/'); ?>" class="img-prod">
      <div class="card mb-3" style="max-width: 540px;">
      <div class="row no-gutters">
        <div class="col-md-4">
          <img src="<?php echo base_url('assets/uploads/products/'. $discount->picture_name); ?>" class="card-img" alt="<?php echo $discount->name; ?>">
        </div>
        <div class="col-md-8">
          <div class="card-body">
            ...
            <p class="card-text text-danger" style="text-decoration: line-through;"><?php echo format_rupiah($discount->price); ?> </p>
            <h4 class="card-text font-weight-bold"><?php echo format_rupiah($discount->price - $discount->current_discount); ?></h4>
          </div>
        </div>
      </div>
    </div>
