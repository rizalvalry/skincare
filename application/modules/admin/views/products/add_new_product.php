...
<div class="container-fluid mt--6">
            ...
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" id="add-sub-product" class="btn btn-danger mt-3">Tambah Sub
                            Produk</button>
                    </div>
                </div>
            </div>
    ...
    $(document).ready(function() {
        $('#add-sub-product').on('click', function() {
            var newSubProduct = `
            <div class="sub-product-item mt-3">
                <label for="sub_product_name">Nama Sub Produk:</label>
                <input type="text" name="sub_product_names[]" class="form-control" placeholder="Nama Sub Produk">
                <label for="sub_product_price">Harga Sub Produk:</label>
                <input type="text" name="sub_product_prices[]" class="form-control" placeholder="Harga Sub Produk">
                <button type="button" class="btn btn-danger btn-sm remove-sub-product mt-2">Hapus</button>
            </div>
        `;
            $('#sub-product-section').append(newSubProduct);
        });
