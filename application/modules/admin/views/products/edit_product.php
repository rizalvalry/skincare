...
<div class="container-fluid mt--6">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered" id="subProductsTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="sub_product_names[]"
                                                    value="<?php echo $sub_product->name; ?>" class="form-control">
                                            </td>
                                            <td>
                                                <input type="text" name="sub_product_prices[]"
                                                    value="<?php echo $sub_product->price; ?>" class="form-control">
                                            </td>
                                            <td>
                                                <button type="button"
                                                    class="btn btn-danger btn-sm removeSubProduct">Hapus</button>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                        <?php endif; ?>
                                ...
                                <button type="button" class="btn btn-primary btn-sm" id="addSubProduct">Tambah Sub
                                    Produk</button>
                            </div>
                        </div>
    ...
    $(document).ready(function() {
        $('#addSubProduct').click(function() {
            $('#subProductsTable tbody').append(`
            <tr>
                <td><input type="text" name="sub_product_names[]" class="form-control" placeholder="Nama Sub Produk"></td>
                <td><input type="text" name="sub_product_prices[]" class="form-control" placeholder="Harga"></td>
                <td><button type="button" class="btn btn-danger btn-sm removeSubProduct">Hapus</button></td>
            </tr>
        `);
        });

        $('#subProductsTable').on('click', '.removeSubProduct', function() {
