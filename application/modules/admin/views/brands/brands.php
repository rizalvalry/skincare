        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Kelola Brands</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="<?php echo site_url('admin'); ?>"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="<?php echo site_url('admin/brands'); ?>">Brands</a></li>
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush" id="packageList" style="width: 100%">
                <thead class="thead-light">
                  <tr>
                    <th scope="col">#</th>
                    <th scope="col">Brands Picture</th>
                    <th scope="col"></th>
                  </tr>
                </thead>
              </table>
          ...
          <div class="modal-body p-0">
              <div class="card bg-secondary border-0 mb-0">
                  <div class="card-header bg-transparent">
                      <h3 class="card-heading text-center mt-2">Tambah Brands</h3>
                  </div>
                  <div class="card-body px-lg-5 py-lg-5">
                      <form role="form" action="#" enctype="multipart/form-data" method="POST" id="addBrandForm">
  ...
  <div class="modal-dialog modal- modal-dialog modal-md" role="document">
      <div class="modal-content">
          <div class="modal-body p-0">
              <div class="card bg-secondary border-0 mb-0">
                  <div class="card-header bg-transparent">
                      <h3 class="card-heading text-center mt-2">Edit Brand</h3>
                  </div>
                  <div class="card-body px-lg-5 py-lg-5">
                      <form role="form" action="#" method="POST" enctype="multipart/form-data" id="editCouponForm">
                        
                        <input type="hidden" name="id" value="" class="edit-id">

                        <div class="form-group edit-picture_name">
                            <div class="col-md-9">
                                (No photo)
                                <span class="help-block"></span>
                            </div>
                            <label class="control-label col-md-3">Ganti
                            <input name="picture" class="form-control edit-picture_name" placeholder="Gambar Brand" type="file" maxlength="255" required>
                            </label>
                        </div>
...
<script>
  $(document).ready(function() {
    ...
    $(document).on('click', '.btnEdit', function() {
      ...
      $.ajax({
        method: 'GET',
        url: '<?php echo site_url('admin/brands/brand_api?action=view_data'); ?>',
        data: {id: id},
        success: function(res) {
          if (res.data) {
            ...
            $('.edit-picture_name').show(); // show photo preview modal
 
            if(d.picture_name)
            {
                $('#label-photo').text('Change Photo'); // label photo upload
                $('.edit-picture_name div').html('<img src="<?php echo base_url('assets/uploads/brands/'); ?>'+d.picture_name+'" class="img-thumbnail" style="width:100px;">'); // show photo

            }
            else
            {
                $('#label-photo').text('Upload Photo'); // label photo upload
                $('.edit-picture_name div').text('(No photo)');
            }
 
            // $('.edit-picture_name').src('data:image/png;base64,'+d.picture);
    ...
    $('#editCouponForm').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('admin/brands/brand_api?action=edit_brand'); ?>',
    ...
    $('#addBrandForm').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('admin/brands/brand_api?action=add_brand'); ?>',
        data: new FormData(this),
        processData:false,
        contentType:false,
        cache:false,
        ...
        success: function(res) {
          if (res.data) {
            ...
            setTimeout(function() {
              $('#addBrandForm .form-control').val(null);
              btn.html('Tambah');
            }, 2000);
            setTimeout(() => {
              $('#addModal').modal('hide');
    ...
    $('#deleteCoupon').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('admin/brands/brand_api?action=delete_brand'); ?>',
        data: {
            id: id
        },
        success: function (res) {
    ...
    var table = $('#packageList').DataTable({
      "ajax" : "<?php echo site_url('admin/brands/brand_api?action=brand_list'); ?>",
      "columns" : [
        {
            "data": "id",
        ...
        {"data": "picture_name","render": function(data, type, row) {
                    return '<img src="<?php echo base_url('assets/uploads/brands/'); ?>'+data+' "class="img-thumbnail" style="width:50px;" />';}},
