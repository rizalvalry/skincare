                    ...
                    <div class="card-body p-0">
                        <table class="table table-hover table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td><b><?php echo ($data->payment_method == 1) ? 'Transfer Manual/COD' : 'Payment Gateway (Online)'; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <td>Status</td>
            ...
            <div class="col-md-4">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="alert alert-info m-2"><?= strtoupper($data->payment_type); ?></div>
                        <?php else : ?>
                        <table class="table table-hover table-striped table-hover">
                            <tr>
                                <td>Transfer</td>
				...
				case 1: ?>
                            ...
                            <a href="<?php echo site_url('customer/payments/confirm?order='. $data->id); ?>"
                                class="btn btn-success">Konfirmasi Pembayaran</a>
                            <br>
                            <a href="#" class="btn btn-danger" data-toggle="modal"
                                data-target="#cancelModal">Batalkan</a>
                            <?php break; ?>
                            <?php case 2: ?>
